...
## 2 Preparing sources
### 2.1 Get sources
Download latest realease ([0.2.9](https://github.com/milikhin/seabass/archive/v0.2.9.tar.gz)):

```
wget https://github.com/milikhin/seabass/archive/v0.2.9.tar.gz
tar -xf v0.2.9.tar.gz
```
